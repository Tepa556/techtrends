  ...
  const PostCard: React.FC<PostCardProps> = ({ post, featured = false }) => {
    ...
    return (
      <article className={`bg-white rounded-lg shadow-md overflow-hidden transform transition-transform duration-300 hover:-translate-y-2 ${featured ? 'md:col-span-2' : ''}`}>
