    ...
    return (
        <section className={`pt-24 pb-12 md:pt-32 md:pb-20  ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
            <div className="container relative mx-auto px-4 text-center">
                ...
                <p className={`text-lg md:text-xl text-gray-800 max-w-2xl mx-auto mb-8 animate-slide-up ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Будьте в курсе с глубокими статьями и аналитикой по программированию, веб-разработке, ИИ и многому другому от экспертов отрасли.</p>
