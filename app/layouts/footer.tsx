                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <ul className="mt-4 grid grid-cols-2 md:grid-cols-1 gap-2">
                            <li><a href="/category/Веб-разработка" className={`text-sm hover:text-blue-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Веб-разработка</a></li>
                            <li><a href="/category/Мобильная-разработка" className={`text-sm hover:text-blue-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Мобильная разработка</a></li>
                            <li><a href="/category/Искусственный-интеллект" className={`text-sm hover:text-blue-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Искусственный интеллект</a></li>
                            <li><a href="/category/Облачные-технологии" className={`text-sm hover:text-blue-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Облачные технологии</a></li>
                            <li><a href="/category/Кибербезопасность" className={`text-sm hover:text-blue-600 transition-colors ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>Кибербезопасность</a></li>
                        </ul>
                    </div>
                    <div className="md:col-span-1">
